# S.A.R.A-
S.A.R.A.| Intelligence for Live Entertainment — Sistema de Automatización y Rendimiento Artístico. como primer modulo MVP se desarrolla un motor de liquidación y auditoría de nómina para artes escénicas, 100% self-hosted con IA local (Llama 3.1 + RAG). Cero costo en APIs externas, soberanía total de datos.
